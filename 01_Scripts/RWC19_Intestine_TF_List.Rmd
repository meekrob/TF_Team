...
int_TF_df_tintori_heatmap <- pheatmap(int_tf_df_tintori_filtered[,2:4], cluster_cols = F, cellwidth = 10, cellheight = 10, filename = "Intestine_TF_Tintori_Heatmap.pdf")
...
pheatmap(int_TF_df_tintori_of_interest_invert, cluster_cols = F)
```
